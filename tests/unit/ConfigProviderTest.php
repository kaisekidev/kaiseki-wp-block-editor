...
namespace Kaiseki\Test\Unit\WordPress\BlockEditor;

use Kaiseki\WordPress\BlockEditor\AddBlockCategories;
use Kaiseki\WordPress\BlockEditor\AddBlockCategoriesFactory;
use Kaiseki\WordPress\BlockEditor\ConfigProvider;
use Kaiseki\WordPress\BlockEditor\ConfigureAllowedBlockTypes;
use Kaiseki\WordPress\BlockEditor\ConfigureAllowedBlockTypesFactory;
use Kaiseki\WordPress\BlockEditor\DisableBlockEditorForPosts;
use Kaiseki\WordPress\BlockEditor\DisableBlockEditorForPostsFactory;
use Kaiseki\WordPress\BlockEditor\DisableBlockEditorForPostTypes;
use Kaiseki\WordPress\BlockEditor\DisableBlockEditorForPostTypesFactory;
use Kaiseki\WordPress\BlockEditor\DisableEmbedVariations;
use Kaiseki\WordPress\BlockEditor\DisableEmbedVariationsFactory;
use Kaiseki\WordPress\BlockEditor\ReplaceBlockEditorTitleInputPlaceholder;
use Kaiseki\WordPress\BlockEditor\ReplaceBlockEditorTitleInputPlaceholderFactory;
use Kaiseki\WordPress\BlockEditor\SetupBlockEditorThemeSupport;
use Kaiseki\WordPress\BlockEditor\SetupBlockEditorThemeSupportFactory;
        ...
        self::assertSame(
            [
                'block_editor' => [
                     ...
                     *
                     * To get a list of all available embed variations open the block editor in your browser and paste
                     * this JavaScript code into your console in order to save an array of all variations in your
                     * clipboard: copy(wp.blocks.getBlockVariations("core/embed").map(variation => variation.name));
                     */
